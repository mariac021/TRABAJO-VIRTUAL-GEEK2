...
button.addEventListener('click', () => document.querySelector('ul').innerHTML = '<li id="One" onclick="first()">Inception</li><li onclick="second()">The butterfly effect</li><li onclick="third()">Eternal sunshine of the spotless mind</li><li onclick="forthd()">Blue velvet</li><li onclick="fiveth()">Split</li>'
 );
